...
export default function Browse() {
  ...
  // Profile-specific animated GIF backgrounds (hosted locally for reliability)
  const profileBackgrounds = {
    Recruiter: "/bg-recruiter.gif",
    Developer: "/bg-developer.gif",
    Collaborator: "/bg-collaborator.gif",
    Explorer: "/bg-explorer.gif",
  }
